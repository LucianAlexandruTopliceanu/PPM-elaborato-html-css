                ...
                <div className="col-xl-8">
                    <div className="row">
                        <div className="row separator">
                            <div className="col-xl-8"><MainArticle/></div>
                            <div className="col-xl-4">
                                <div className="row ">
                                    <div className="col-xl-12"><BasicArticle/></div>
                                </div>
                    ...
                    <div className="row">
                        <div className="col-xl-4"><DetailedArticle/></div>
                        <div className="col-xl-4"><DetailedArticle/></div>
                        <div className="col-xl-4"><DetailedArticle/></div>
                    </div>
                    <div className=" row separator"></div>
                    <div className="row">
                        <div className="col-xl-12"><Podcast/></div>
                    </div>
                    <div className=" row separator"></div>
                    <div className="row separator">
                        <div className="col-xl-6"><BasicArticleWide/></div>
                        <div className="col-xl-6"><BasicArticleWide/></div>
                    </div>
                    <div className="row separator">
                        <div className="col-xl-6"><BasicArticleWide/></div>
                    ...
                    <div className="row separator">
                        <div className="col-xl-6"><BasicArticleText/></div>
                        <div className="col-xl-6"><BasicArticleText/></div>
                    </div>
                    <div className="row separator">
                        <div className="col-xl-6"><BasicArticleText/></div>
